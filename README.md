...
- **[dsh-budget](https://github.com/PerryLink/dsh-budget)**（[@PerryLink](https://github.com/PerryLink) · 2026-08-16）— 成本治理：按模型/会话/天聚合 token 与费用计量，会话/日/月预算上限 + 阈值告警与超限 alert/block/degrade 策略，碳足迹估算、分模型延迟基准、Settings 预算页与 /budget 命令。

...
- **[dsh-mask](https://github.com/PerryLink/dsh-mask)**（[@PerryLink](https://github.com/PerryLink) · 2026-08-17）— PII 脱敏中间件：在模型边界前把姓名/电话/邮箱/身份证/银行卡/密钥/地址替换为占位符，展示层还原；明文绝不入会话日志；/mask 命令 + mask_test 工具。适合处理敏感数据、看重隐私与合规的 DSH 用户。

...
- **[dsh-talk](https://github.com/PerryLink/dsh-talk)**（[@PerryLink](https://github.com/PerryLink) · 2026-08-16）— 语音优先会话闭环：作曲器麦克风按钮 + 浏览器/本地语音转写（Web Speech、FunASR、whisper.cpp），speak 工具朗读回复（browser、edge-tts、piper），事件播报带静音开关，说话打断。

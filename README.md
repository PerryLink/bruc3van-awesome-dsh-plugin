...
- **[dsh-click](https://github.com/PerryLink/dsh-click)**（[@PerryLink](https://github.com/PerryLink) · 2026-08-16）— DeepSeek Harness 原生桌面控制（Windows 优先）：截图、无障碍树结构化读取、点击/输入/滚动/按键与应用启动，变更性操作过审批门禁、屏幕变化拒绝执行、操作前后校验进程身份。

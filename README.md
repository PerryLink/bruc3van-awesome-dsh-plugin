...
- **[dsh-observe](https://github.com/PerryLink/dsh-observe)**（[@PerryLink](https://github.com/PerryLink) · 2026-08-16）— 可观测导出器：把 session/event 流导出为 OTLP traces/metrics 与 Langfuse 观测，异步批量 + 有界离线缓冲 + 退避重试，发送前经脱敏层，默认关闭、显式配置才启用。

...
- **[dsh-github](https://github.com/PerryLink/dsh-github)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Official-grade GitHub CI integration: a composite action.yml, a polling PR review bot with idempotent inline comments and a status-check gate, the /pr /review /issue command family and 12 PR/issues tools — every write gated by human approval; npm @perrylink/dsh-github 0.6.1.

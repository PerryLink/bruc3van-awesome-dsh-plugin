...
- **[dsh-translate](https://github.com/PerryLink/dsh-translate)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Vendor parameter translation and deterministic JSON repair for DeepSeek Harness: the /translate command maps 13 canonical parameters across 11 vendors, and the post-execute repair layer (plus fix_json) fixes broken JSON tool output without fabricating data.

...
- **[dsh-observe](https://github.com/PerryLink/dsh-observe)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Observability exporter for DeepSeek Harness: turns the session/event stream into OTLP traces/metrics and Langfuse observations, with async batching, a bounded offline buffer, retry backoff and a pre-send sanitization layer; off by default, explicit opt-in.

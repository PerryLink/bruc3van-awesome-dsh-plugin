...
- **[dsh-mask](https://github.com/PerryLink/dsh-mask)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-17) — PII masking middleware: anonymizes names, phones, emails, ID cards, bank cards, keys, and addresses before the model boundary and restores placeholders at display; plaintext never enters the session log; /mask command plus mask_test tool. For DSH users handling sensitive data with privacy and compliance needs.

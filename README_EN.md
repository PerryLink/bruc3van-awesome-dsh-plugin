...
- **[dsh-skill-pack-security](https://github.com/PerryLink/dsh-skill-pack-security)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — A security-audit methodology skill pack plus the plugin_vet supply-chain gate: eight agent skills (secret scan, dependency audit, supply-chain review, prompt-injection review, audit orchestration, threat modeling, vuln intel, incident response) in Chinese and English editions; mounted through the npm provider bundle (@perrylink/dsh-skill-pack-security-provider 2.0.0), which also registers the automated plugin_vet pre-install scan (license / SBOM / commit pinning / malicious patterns / five-dimension risk card), warn by default, deny optional.

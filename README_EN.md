...
- **[dsh-click](https://github.com/PerryLink/dsh-click)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Native desktop control for DeepSeek Harness (Windows first): screen_shot, screen_read accessibility trees, click/type/scroll/key, and app launch — every mutating action approval-gated, with stale-screen rejection and process-identity checks.

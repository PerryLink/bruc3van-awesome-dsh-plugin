...
- **[dsh-budget](https://github.com/PerryLink/dsh-budget)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Cost governance for DeepSeek Harness: aggregated token/cost metering per model, session and day, session/daily/monthly budget caps with threshold alerts and over-limit policies, carbon footprint estimation, per-model latency benchmarks, a Settings budget tab, and the /budget command.

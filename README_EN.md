...
- **[dsh-claude-move](https://github.com/PerryLink/dsh-claude-move)** ([@PerryLink](https://github.com/PerryLink) · 2026-08-16) — Four-source migration wizard: moves Claude Code, Codex, OpenCode and Hermes sessions/memories/skills/instructions/slash commands into DSH (/move wizard plus move_detect/preview/run tools, approval-gated, idempotent move.json, conflicts as diffs, resumable sessions); the phase-1 Claude importers stay; npm dsh-claude-move 0.2.1.
